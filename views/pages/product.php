<section>
  <div class="flex">
    <div class="w-5/12 px-5 lg:px-20 mt-10">
      <div class="">
        <img src="https://templateprj.vercel.app/img/products/f1.jpg" />
      </div>
      <div class="flex">
     ...
     <div class="flex">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="flex items-center mr-4">
            <input id="red-radio" type="radio" value="" name="colored-radio" class="ml-2 w-10 h-10 accent-black  rounded-full text-black "  >
            <label for="red-radio" class="ml-2 text-sm font-medium  dark:text-gray-300"></label>
        </div>
        <div class="flex items-center mr-4">
            <input id="green-radio" type="radio" value="" name="colored-radio" class="w-10 h-10 accent-white outline-slate-50 rounded-full">
            <label for="green-radio" class="ml-2 text-sm font-medium dark:text-gray-300"></label>
        </div>
        <div class="flex items-center mr-4">
            <input checked id="purple-radio" type="radio" value="" name="colored-radio" class="w-10 h-10 accent-red-500 rounded-full">
            <label for="purple-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
        </div>
        <div class="flex items-center mr-4">
            <input id="teal-radio" type="radio" value="" name="colored-radio" class="w-10 h-10 accent-blue-700 rounded-full">
            <label for="teal-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
        </div>
