    ...
    <div class="w-5/12 px-5 lg:px-20 mt-10">
      ...
      <div class="flex">
        <div class="w-4/12 mt-2">
          <img
            src="https://templateprj.vercel.app/img/products/f1.jpg"
            alt=""
          />
        </div>
    ...
    <div class="w-7/12 mt-10">
      ...
      <div class="py-5 font-bold text-2xl">
        ...
        <div class="inline-block relative w-[2rem]">
          <select
            class="block appearance-none w-[2rem] bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-center text-xs"
          >
            <option id="">S</option>
            <option id="">L</option>
            <option id="">XL</option>
