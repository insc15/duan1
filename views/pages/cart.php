...
<section class="pt-9 max-w-screen-xl mx-auto items-center font-[Montserrat] mt-4">
      ...
      <div class="flex justify-center mt-4">
         ...
         <div class="w-8/12 pr-3 ">
            <!-- products -->
            <div class="flex justify-center rounded-lg shadow-xl border-2">
                  <div class="m-1 w-24">
                     <div class="overflow-hidden relative pt-[100%]">
                        <img class="absolute top-0 h-24" src="https://templateprj.vercel.app/img/products/f1.jpg" alt="">
                     </div>
                  </div>
                  <div class="flex w-4/12  items-center ml-6">
                     <div>
                        <h3 class="text-[#041E42] text-base font-bold font-[Montserrat] ">Cartoon Astronaut T-Shirts</h3>
                        <div class="flex mt-2">
                           <div class="mr-1">
                              <input type="number"class="appearance-none form-input block w-11 h-6 text-xs p-1 outline-none border-2 rounded-md text-gray-900"value="0"/>
                           </div>
                           <div class="ml-1">
                              <input type="number"class="appearance-none form-input block w-11 h-6 text-xs p-1 outline-none border-2 rounded-md  text-gray-900"value="0"/>
                           </div>
                  ...
                  <div class="w-5/12 flex  items-center ">
                     <div>
                        <p class="text-base font-normal ml-32">150.000 đ</p>
                     </div>
                  </div>
                  <div class="w-3/12 flex justify-center items-center">
                     <div class="pr-4 flex ">
                                 <a href="" class=" text-[#041E42] w-7 h-7 rounded flex justify-center items-center hover:bg-[#041E42] hover:text-white">
                                    <span class="material-symbols-rounded">remove</span>
                                 </a>
                                 <div class="flex justify-center items-center"> 
                                    <input type="text" class="focus:outline-none   h-6 w-8  text-base px-2 mx-2" value="1">
                                 </div>
            ...
            <div class="flex mb-20 font-[Montserrat]">   
               <a href="" class="flex justify-center items-center text-base text-[#088178] border-[#088178] border py-1 px-3 rounded mt-3 ml-1 hover:bg-[#041E42] hover:text-white">
                  <span class="material-symbols-rounded">arrow_back</span>
                  <span class="ml-3">Continue shopping</span>
               </a>
               <a href="" class="border py-1 px-4 rounded mt-3 ml-2 bg-[#041E42] text-white text-base hover:bg-white hover:text-[#088178] hover:border-[#088178]">Update cart</a>
               
            </div>
         </div>
         <!-- right -->
         <div class="w-4/12 pl-3 mt-2 font-[Montserrat] pb-3">
            <div class="rounded-lg shadow-xl border-2 py-4 grid grid-cols-2 px-4 font-[Montserrat]">
               <span class="text-left font-semibold ">Total</span>
               <span class="text-right text-[#088178]">1.000.000.000đ</span>
            </div>
            <a href="" class="rounded-xl  border-2 py-3 grid grid-cols-1 px-4 font-[Montserrat] mt-4 text-center text-white bg-[#041E42] hover:bg-white hover:text-[#088178] hover:border-[#088178]">
               Proceed checkout
            </a>
            <!-- method -->
               ...
               <div class=" flex mt-3">
                  ...
                  <a href="" class="mr-4">
                     <svg width="47" height="32" viewBox="0 0 47 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M19.6021 15.9999C19.6006 14.3846 19.9735 12.7902 20.6925 11.3372C21.4115 9.88434 22.4578 8.61105 23.7522 7.61379C22.1493 6.37694 20.2242 5.60776 18.1971 5.39417C16.1699 5.18058 14.1224 5.53118 12.2887 6.40592C10.4549 7.28067 8.90882 8.64425 7.82715 10.3408C6.74548 12.0374 6.17188 13.9984 6.17188 15.9999C6.17188 18.0014 6.74548 19.9624 7.82715 21.659C8.90882 23.3555 10.4549 24.7191 12.2887 25.5939C14.1224 26.4686 16.1699 26.8192 18.1971 26.6056C20.2242 26.392 22.1493 25.6229 23.7522 24.386C22.4578 23.3887 21.4115 22.1154 20.6925 20.6625C19.9735 19.2096 19.6006 17.6152 19.6021 15.9999Z" fill="#EB001B"/>
                        <path d="M41.332 15.9999C41.332 18.0013 40.7585 19.9624 39.6769 21.659C38.5953 23.3555 37.0492 24.7191 35.2155 25.5938C33.3818 26.4686 31.3343 26.8192 29.3072 26.6056C27.2801 26.392 25.3551 25.6229 23.7522 24.386C25.0454 23.3877 26.0909 22.1142 26.8098 20.6616C27.5287 19.2089 27.9022 17.6149 27.9022 15.9999C27.9022 14.3849 27.5287 12.7909 26.8098 11.3382C26.0909 9.88555 25.0454 8.61206 23.7522 7.61378C25.3551 6.37693 27.2801 5.60776 29.3072 5.39417C31.3343 5.18058 33.3818 5.5312 35.2155 6.40595C37.0492 7.2807 38.5953 8.64428 39.6769 10.3408C40.7585 12.0374 41.332 13.9985 41.332 15.9999Z" fill="#F79E1B"/>
                        <path d="M40.2953 22.6096V22.2662H40.4363V22.1962H40.0771V22.2662H40.2183V22.6096H40.2953ZM40.9927 22.6096V22.1956H40.8826L40.7559 22.4803L40.6293 22.1956H40.5191V22.6096H40.5968V22.2973L40.7156 22.5665H40.7962L40.915 22.2966V22.6096H40.9927Z" fill="#F79E1B"/>
                     </svg>
                  </a>
                  <a href="" class="mr-4">
                      <svg width="47" height="32" viewBox="0 0 47 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <g clip-path="url(#clip0_252_211)">
                     <path d="M1.10303 26.9092C1.10303 28.2594 1.69936 29.5543 2.76085 30.509C3.82233 31.4637 5.26202 32.0001 6.76318 32.0001H40.7241C42.2253 32.0001 43.665 31.4637 44.7265 30.509C45.7879 29.5543 46.3843 28.2594 46.3843 26.9092V12.9092H1.10303V26.9092ZM7.77393 20.0001C7.77393 19.2768 8.09339 18.5831 8.66204 18.0716C9.2307 17.5602 10.002 17.2728 10.8062 17.2728H15.6577C16.4619 17.2728 17.2332 17.5602 17.8018 18.0716C18.3705 18.5831 18.6899 19.2768 18.6899 20.0001V21.8183C18.6899 22.5416 18.3705 23.2353 17.8018 23.7467C17.2332 24.2582 16.4619 24.5455 15.6577 24.5455H10.8062C10.002 24.5455 9.2307 24.2582 8.66204 23.7467C8.09339 23.2353 7.77393 22.5416 7.77393 21.8183V20.0001Z" fill="#041E42"/>
                     <path d="M40.7241 0H6.76318C5.26202 0 3.82233 0.536362 2.76085 1.49109C1.69936 2.44582 1.10303 3.74072 1.10303 5.09091V7.45455H46.3843V5.09091C46.3843 3.74072 45.7879 2.44582 44.7265 1.49109C43.665 0.536362 42.2253 0 40.7241 0Z" fill="#041E42"/>
                     </g>
                     <defs>
