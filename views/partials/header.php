<header class="shadow-lg py-5 px-5 lg:px-20 bg-[#E3E6F3] sticky top-0 z-10">
    <div class="max-w-screen-xl mx-auto flex items-center">
        ...
        <nav class="font-semibold ml-auto flex items-center">
            ...
            <div>
            <a class="hover:text-primary hidden peer relative md:block hidden duration-150 relative after:content-[''] hover:after:w-2/3 after:w-0 after:duration-150 after:bg-primary after:h-[2px] after:left-0 after:-bottom-1 after:absolute mx-5 " id="dropdownDefault" data-dropdown-toggle="dropdown" href="#"><span class="">Shop</span><span class="material-symbols-rounded">expand_more</span></a>
            <!-- dropdown-menu -->
            <div class="hidden absolute pt-5 peer-hover:flex hover:flex w-[200px] flex-col bg-white drop-shadow-lg ">
            <a class="px-5 py-3 hover:bg-gray-200" href="<?php get_home_url()?>">danh muc ?</a>
            <a class="px-5 py-3 hover:bg-gray-200" href="<?php get_home_url()?>">danh muc ?</a>
            <a class="px-5 py-3 hover:bg-gray-200" href="<?php get_home_url()?>">danh muc ?</a>
        </div>
        </div>
